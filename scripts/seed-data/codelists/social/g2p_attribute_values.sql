...
('PREFIX:MR','PREFIX','Mr','Mr',NULL,1),
('PREFIX:MRS','PREFIX','Mrs','Mrs',NULL,2),
('PREFIX:MS','PREFIX','Ms','Ms',NULL,3),
('PREFIX:MISS','PREFIX','Miss','Miss',NULL,4),
('RTH_CHILD','RELATIONSHIP_TO_THE_HEAD','CHILD','CHILD',NULL,1),
('RTH_SPOUSE','RELATIONSHIP_TO_THE_HEAD','SPOUSE','SPOUSE',NULL,2),
('RTH_OTHER','RELATIONSHIP_TO_THE_HEAD','OTHER','OTHER',NULL,3)
